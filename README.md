...
5. Add JAVA_HOME to your Environment Path. (path to JDK)
...
### You can find detailed incstructions on how to run a maven project [here](https://maven.apache.org/run.html)

...
class Settings
{
   ...
   data class jsonsettings(
       ...
       val airDropTextScale : Float = 800f ,

       //
       // Scales
       //
       val itemScale : Float = 20f ,
       val staticItemScale : Float = 250f ,
       val mapMarkerScale : Float = 300f ,
       val airDropScale : Float = 200f ,
